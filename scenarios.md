...
| ID | Typ | Opis | Status |
|---|---|---|---|
| S-01 | UNIT | `create_session()` zwraca Session z poprawnym modelem i pustą historią | todo |
| S-02 | UNIT | `create_session()` z nieznanym modelem rzuca `ValueError` | todo |
...
| ID | Typ | Opis | Status |
|---|---|---|---|
| AS-01 | UNIT | `AgentState` ma pola: `messages`, `model`, `context_loaded`, `done`, `error_count` | todo |
