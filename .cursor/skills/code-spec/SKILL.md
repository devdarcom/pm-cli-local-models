...
- `architecture/CHANGE_LOG.md`

Alignment output required:
- `TASK_CONTEXT.md` (task-specific architecture summary)

Hard gate:
- If `TASK_CONTEXT.md` contains red flags or `confidence: low`, stop and ask the
  user for decision before continuing.

Use `TASK_CONTEXT.md` as primary architecture context for the scenario.
...
4. `TASK_CONTEXT.md` (generated by architecture-alignment)
